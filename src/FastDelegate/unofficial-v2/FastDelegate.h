...
public:
	...
	FastDelegateImpl(LambdaType p_LambdaExpression, Args... p_Args)
	{
		*this = p_LambdaExpression;
	}*/
	template <typename LambdaType>
	void operator= (LambdaType lambdaExpression)
	{
		m_Closure.bindmemfunc(&lambdaExpression, &(LambdaType::operator()));
	}
	// /EXPERIMENTAL
